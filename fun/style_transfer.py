# -*- coding: utf-8 -*-
"""
Created on Wed Aug 29 12:38:29 2018
...
if __name__ == "__main__":
    data_dir = "F:/"
    style_img = image_loader(data_dir+"images/picasso.jpg")
    content_img = image_loader(data_dir+"images/dancing.jpg")
    ...
    output = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                                content_img, style_img, input_img, style_weight=1e6)
