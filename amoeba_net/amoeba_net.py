...
# Modified by Yang Fu to enable fine-tuning
# 2019/04/11
...
from official.amoeba_net import amoeba_net_model as model_lib

#import random as rn
#rand_id = '/' + str(rn.randint(1000,9999))
...
flags.DEFINE_integer(
    'num_cells', 12, 'The total number of regular cells.')
flags.DEFINE_integer(
    'reduction_size', 256, 'Default cell reduction size.')
flags.DEFINE_integer(
    'stem_reduction_size', 32, 'Stem filter size.')
flags.DEFINE_integer(
    'num_reduction_layers', 2, 'Number of reduction cells between the stacks of regular cells.')
flags.DEFINE_float(
